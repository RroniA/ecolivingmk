...
function GlassCard({ onPlay }: { onPlay: () => void }) {
  ...
  return (
    <motion.div
      ...
      className="relative w-full max-w-[340px] rounded-2xl overflow-hidden border border-white/20 bg-white/10 backdrop-blur-[24px] p-6 flex flex-col gap-6"
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 w-14 h-14 rounded-full border-2 border-white/70 flex items-center justify-center text-white group-hover:scale-110 group-hover:border-[#b6e400] group-hover:text-[#b6e400] transition-all duration-300">
          <PlayIcon />
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 border-t border-white/10 pt-4">
        <div className="flex flex-col gap-0.5">
          <span className="font-['Geologica'] text-[22px] font-light text-white leading-none">36K+</span>
          <span className="font-['Jost'] text-[11px] text-white/50 uppercase tracking-widest">{t.hero.happy_clients}</span>
        </div>
        <div className="flex flex-col gap-0.5">
          <span className="font-['Geologica'] text-[22px] font-light text-white leading-none">120+</span>
          <span className="font-['Jost'] text-[11px] text-white/50 uppercase tracking-widest">{t.hero.companies}</span>
        </div>
      </div>
    </motion.div>
  );
...
export default function Hero() {
  ...
  const contentBlur = useTransform(scrollY, [0, 500], ["blur(0px)", "blur(10px)"]);
    ...
    <>
      ...
      <section className="sticky top-0 h-screen w-full overflow-hidden bg-[#1a1a17] z-0">
        ...
        <div className="absolute inset-0 w-full h-full">
          <video className="w-full h-full object-cover" autoPlay muted loop playsInline preload="auto" aria-hidden="true">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12 lg:gap-8">
              ...
              <div className="flex flex-col gap-6 max-w-xl">
                ...
                <motion.h1
                  ...
                  className="font-['Geologica'] text-[clamp(2.6rem,6.5vw,5.2rem)] font-light leading-[1.04] tracking-[-0.025em] text-[#f4f3ea]"
                >
                ...
                <motion.p
                  ...
                  className="font-['Jost'] text-[17px] leading-relaxed text-white/65 max-w-md"
                >
                  {t.hero.subtitle}
                </motion.p>
                ...
                >
                  <div className="flex -space-x-2.5">
                    {[0, 1, 2].map((i) => (
                      <div key={i} className="w-8 h-8 rounded-full border-2 border-[#f4f3ea] bg-[#b6e400]/30" />
                    ))}
                  </div>
